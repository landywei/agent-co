...
export function createGatewayTool(opts?: {
  ...
  return {
    ...
    ownerOnly: true,
    description:
      "Restart, apply config, or update the gateway. Use config.patch for partial updates, config.apply for full replacement. Pass a `note` for post-restart delivery.",
